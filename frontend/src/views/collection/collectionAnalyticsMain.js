...
import FilterAnalyticsSection from './filterAnalyticsSection';
...
import AnalyticsCollection from './collectionAnalytics';
            ...
            <div className="col-lg-12">
              <div className="itemWizard">
                <div className={`filterSection ${isFilterView ? 'show' : 'hide'}`} >
                  <FilterAnalyticsSection />
                </div>
                <div className={`viewItemscard ${isFilterView ? 'collapseWidth' : 'fullWidth'}`}>
                  <div className="form-inline">
                    <div className="form-group formInputs mr-3 flex-grow-1 filterGroup">
                    ...
                    <div className="form-group formInputs mb-2">
                      {/* <Input type="select">
                       ...
                       <Dropdown isOpen={dropdownOpen} toggle={toggleDropdown} className='customdropdown'>
                        <DropdownToggle>
                            <span>All Time</span> <i className={`fas ${dropdownOpen ? 'fa-angle-up' : 'fa-angle-down'}`}></i>
                        </DropdownToggle>
                        <DropdownMenu right>
                            <DropdownItem><div>All Time</div><div><CheckTick /></div></DropdownItem>
                            <DropdownItem><div>Last Hour</div><div><CheckTick /></div></DropdownItem>
                            <DropdownItem><div>Last 6 Hours</div><div><CheckTick /></div></DropdownItem>
                            <DropdownItem><div>Last 24 Hours</div><div><CheckTick /></div></DropdownItem>
                            <DropdownItem><div>Last 7 Days</div><div><CheckTick /></div></DropdownItem>
                            <DropdownItem><div>Last 30 Days</div><div><CheckTick /></div></DropdownItem>
                            <DropdownItem><div>Last 90 Days</div><div><CheckTick /></div></DropdownItem>                    
                        </DropdownMenu>
                      </Dropdown>
                    </div>

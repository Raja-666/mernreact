                ...
                <div className='row'>
                    <div className="col-lg-12">
                        <div className='d-flex justify-content-between mb-4'>
                            <div className='cmsTit'>Privacy Policy</div>
                            <div className='cmsdateTxt'>Last modification: July 1st, 2023</div>
                        </div>
                        <div className='cmsSubTit'>Header 2</div>
                        ...
                        <div className='cmsSubTit'>Header 2</div>
                        <div className='cmsPage'>
                            <ul className='cmsUlList'>
                                <li>
                                    <span className='fw-700'>Point 1.</span> Vestibulum sed arcu non odio. Varius duis at consectetur lorem. Bibendum neque egestas congue quisque egestas diam in arcu. Nisl tincidunt eget nullam non nisi est sit amet facilisis. Eget velit aliquet sagittis id consectetur.
                                </li>
                                <li>
                                    <span className='fw-700'>Point 2.</span> Vestibulum sed arcu non odio. Varius duis at consectetur lorem. Bibendum neque egestas congue quisque egestas diam in arcu. Nisl tincidunt eget nullam non nisi est sit amet facilisis. Eget velit aliquet sagittis id consectetur.
                                </li>
                                <li>
                                    <span>Point 3.</span> Vestibulum sed arcu non odio. Varius duis at consectetur lorem. Bibendum neque egestas congue quisque egestas diam in arcu. Nisl tincidunt eget nullam non nisi est sit amet facilisis. Eget velit aliquet sagittis id consectetur.
                                </li>
                            </ul>
                            <p>Vestibulum sed arcu non odio. Varius duis at consectetur lorem. Bibendum neque egestas congue quisque egestas diam in arcu. Nisl tincidunt eget nullam non nisi est sit amet facilisis. </p>
                        </div>
                        <div className='cmsSubTit'>Header 2</div>
                        <div className='cmsPage'>
                            <p>Vestibulum sed arcu non odio. Varius duis at consectetur lorem. Bibendum neque egestas congue quisque egestas diam in arcu. Nisl tincidunt eget nullam non nisi est sit amet facilisis. Eget velit aliquet sagittis id consectetur. Magna fermentum iaculis eu non diam phasellus. Sit amet purus gravida quis blandit turpis. Donec pretium vulputate sapien nec sagittis. Ultrices mi tempus imperdiet nulla malesuada. Sit amet luctus venenatis lectus magna fringilla urna porttitor rhoncus. Proin nibh nisl condimentum id venenatis a condimentum vitae.</p>

...
import FilterActivitySection from './filterActivesection';
import ProfileCollection from './profileActive';
    
const ActivityProfileMain = () => {
...
export default ActivityProfileMain;
...
import FilterSection from './filterCreatesection';
                    ...
                    <div className="form-group formInputs mr-3 mb-2">
                      {/* <Input type="select">
                       ...
                       <Dropdown isOpen={dropdownOpen} toggle={toggleDropdown} className='customdropdown'>
                        <DropdownToggle>
                            <span>Recently Created</span> <i className={`fas ${dropdownOpen ? 'fa-angle-up' : 'fa-angle-down'}`}></i>
                        </DropdownToggle>
                        <DropdownMenu>
                            <DropdownItem><div>Recently Received</div></DropdownItem>
                            <DropdownItem><div>Price: Low - High</div></DropdownItem>
                            <DropdownItem><div>Price: High - Low</div></DropdownItem>
                            <DropdownItem><div>Highest Floor</div></DropdownItem>
                            <DropdownItem><div>Best Offer</div></DropdownItem>
                            <DropdownItem><div>Recently Listed</div></DropdownItem>
                            <DropdownItem><div>Recently Created</div><div><CheckTick /></div></DropdownItem>
                            <DropdownItem><div>Highest For Sale</div></DropdownItem>
                            <DropdownItem><div>Oldest</div></DropdownItem>                          
                        </DropdownMenu>
                      </Dropdown>
                    </div>
                  </div>
                  <ProfileCreate filterview={isFilterView}/>

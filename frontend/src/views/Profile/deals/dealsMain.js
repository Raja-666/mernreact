...
import FilterSection from './dealsFilter';
                    ...
                    <div className="form-group formInputs mr-3 mb-2">
                      {/* <Input type="select">
                       ...
                       <Dropdown isOpen={dropdownOpen} toggle={toggleDropdown} className='customdropdown'>
                        <DropdownToggle>
                            <span>Most Recent</span> <i className={`fas ${dropdownOpen ? 'fa-angle-up' : 'fa-angle-down'}`}></i>
                        </DropdownToggle>
                        <DropdownMenu right>
                            <DropdownItem><div>Most Recent</div><div><CheckTick /></div></DropdownItem>
                            <DropdownItem><div>Expiring Soon</div><div><CheckTick /></div></DropdownItem>
                                                     
                        </DropdownMenu>
                      </Dropdown>
                    </div>
                    <div className="mb-2">
                      <button className='btn btnPrimary'>Make a Deal</button>
                    </div>
                  </div>
                  <div>
                      <DealsContent filterview={isFilterView} />
                  </div>

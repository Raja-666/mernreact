    ...
    return (
        <>
            ...
            <Modal isOpen={props.modalOpen} centered="true" className="mymodal" backdropClassName="selCurBp">
                <ModalHeader onClick={props.closeModal} close={closeBtn}>Make an Offer</ModalHeader>
                <ModalBody>
                    ...
                    <div className='mt-4'>
                        <button className='btn btn-block btnSecondary' onClick={() => setOfferPlaceModal(true)}>Make an Offer </button>
                    </div>
